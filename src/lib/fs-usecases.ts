...
- a "**User interface & messages**" paragraph: screens, fields, labels and error messages ONLY where the facts or the source document specify them; otherwise the single line "No screen change specified."
